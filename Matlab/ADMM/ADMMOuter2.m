function [x, u, cost] = ADMMOuter2(DYNCST, DYNCST2, x0, u0, Op)
...
% --- initial trajectory
[x,un,c0]  = initialtraj(x0,u0,DYNCST);
c01 = sum(c0(:));
...
% x_lambda2 = randn(size(x));
% u_lambda2 = randn(size(u));
...
%         end
    ...
    [~,~,cost22]  = initialtraj(x0,unew,DYNCST);
...
[~,~,costnew]  = initialtraj(x0,unew,DYNCST);
...
function [xnew,unew,cnew] = initialtraj(x0,u0,DYNCST)
