function [x, u, cost] = ADMM_DDP_CEN(DYNCST, DYNCST_primal, x0, u0, Op)
...
%         u_lambda = u_lambda + unew - u_bar;
    ...
    %% ADMM with relaxtion 
        %====== proximal operator to minimize to cost
        % robot manipulator
        [xnew, unew, ~] = iLQG_ADMM_CEN(DYNCST, DYNCST_primal, x0, unew, rhao, x_bar-x_lambda,c_bar-c_lambda,u_bar-u_lambda, Op);
