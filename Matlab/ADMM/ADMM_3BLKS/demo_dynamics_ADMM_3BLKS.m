function [x,u] = demo_dynamics_ADMM_3BLKS(Op)
...
function [c] = admm_robot_cost(x, u, i, rhao, x_bar, c_bar, u_bar, thetalist_bar, thetalistd_bar)
    ...
    % running cost
    lx   = cx_w(15:17) * (x(15:17,:)-x_d(15:17,:)).^2 + ...
            (rhao(1)/2) * ones(1,7)*(x(1:7,:)-x_bar(1:7,:)).^2 + ...
            (rhao(3)/2) * ones(1,2)*(cen - c_bar).^2 + ...
            (rhao(5)/2) * ones(1,7)*(x(1:7,:)-thetalist_bar).^2 + ...
