...
public:
    ...
    void solve(const stateVec_t& x_0, const commandVecTab_t& u_0, const Eigen::MatrixXd& cList_bar, const stateVecTab_t& xList_bar, const commandVecTab_t& uList_bar);
...
private:
    ...
    void doBackwardPass();
    void doForwardPass(const stateVec_t& x_0, const Eigen::MatrixXd& cList_bar, const stateVecTab_t& xList_bar, const commandVecTab_t& uList_bar);
