...
public:
    ...
    CostFunction(const stateVec_t &x_goal, const stateVecTab_t &x_track) : x_track_(x_track) {
        ...
        x_w  << 4000, 4000, 4000, 4000, 4000, 4000, 4000, 100, 100, 100, 100, 100, 100, 100, 0, 0, 100;
        xf_w << 1000, 1000, 1000, 1000, 1000, 1000, 1000, 10000, 10000, 10000, 10000, 10000, 10000, 10000, 0, 0, 100;
