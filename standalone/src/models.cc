...
Chain KukaDHKdl()
{
	...
	KukaDHKdl_.addSegment(Segment(Joint(Joint::RotZ,1,0,0,0,100000),
				  ...
				  Frame::DH_Craig1989(0.0, -1.5707963, 0.4, 0.0).Inverse()*RigidBodyInertia(4.5,
	...
	KukaDHKdl_.addSegment(Segment(Joint(Joint::RotZ,1,0,0,0,100000),
				  ...
				  Frame::DH_Craig1989(0.0, 1.5707963, 0.39, 0.0).Inverse()*RigidBodyInertia(2.61,
